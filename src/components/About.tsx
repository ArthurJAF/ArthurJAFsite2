  ...
  return (
    <main>
		<section className='d-flex flex-column align-items-center text-center'>
			<article className="art1 pb-5">
				<h3>Quem sou eu ?</h3>

				<h2 className=''>Olá, me chamo Arthur Jardim!</h2>
				<div className="">
					<img src="/minha foto.jpg" alt="Foto" className="imagem" />
				</div>
		
				<p>Sou estudante de Sistemas da Informação na Universidade Federal Fluminense - Uff.</p>

				
				<a className='btn  btn-secondary' href="download/CV Arthur Jardim A Ferreira.pdf" download>Download CV</a>

				<button className='btn  btn-primary' id="">Contato<i className="fa">&#xf138;</i></button>	
			</article >
